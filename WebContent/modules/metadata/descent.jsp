...
<title><%=Messages.getString("Metadata.descent.Title") %></title>
...
/*=========连接数据库选择 end============*/	
	...
	function onRefreshClick(){
       	window.location.href = "metadata?action=descent";
    }
});
//点击资源库获取数据源
...
function getReportFlow()
{
	...
	else
	{
		...
		//alert(Ext.getCmp('datasources-txt').getValue());
		//alert(Ext.getCmp('schemas-txt').getValue());
		//alert(Ext.getCmp('tables-txt').getValue());
		//alert(Ext.getCmp('fields-txt').getValue());
	}
	...
	<div id="wizardwrapper">
	  ...
	  <div class="1">
	    <ul id="mainNav" class="threeStep">
	      <li class="current"><a title=""><em><%=Messages.getString("Metadata.navigation.descent.step1") %></em></a></li>
	      <li><a title="" onclick="checkStep1()"><em><%=Messages.getString("Metadata.navigation.descent.step2") %></em></a></li>
	      <li><a title="" onclick="checkStep1();checkStep2();"><em><%=Messages.getString("Metadata.navigation.descent.step3") %></em></a></li>
	    </ul>    
	  ...
	  <div id="wizardpanel" class="2">
	    <ul id="mainNav" class="threeStep">
	      <li class="lastDone"><a onclick="loadnext(2,1)" title=""><em><%=Messages.getString("Metadata.navigation.descent.step1") %></em></a></li>
	      <li class="current"><a title=""><em><%=Messages.getString("Metadata.navigation.descent.step2") %></em></a></li>
	      <li><a title="" onclick="checkStep2()"><em><%=Messages.getString("Metadata.navigation.descent.step3") %></em></a></li>
	    </ul>    
	    <div id="wizardcontent">
	  ...
	  <div id="wizardpanel" class="3">
	    <ul id="mainNav" class="threeStep">
	      <li class="done"><a onclick="loadnext(3,1)" title=""><em><%=Messages.getString("Metadata.navigation.descent.step1") %></em></a></li>
	      <li class="lastDone"><a onclick="loadnext(3,2)" title=""><em><%=Messages.getString("Metadata.navigation.descent.step2") %></em></a></li>
	      <li class="current"><a title=""><em><%=Messages.getString("Metadata.navigation.descent.step3") %></em></a></li>
	    </ul>
