...
INSERT kdi_t_operation VALUES (1,'新建');
INSERT kdi_t_operation VALUES (2,'删除');
INSERT kdi_t_operation VALUES (4,'修改');
INSERT kdi_t_operation VALUES (8,'执行');
INSERT kdi_t_operation VALUES (16,'浏览');
...
INSERT kdi_t_priviledge VALUES(1,1,1);
INSERT kdi_t_priviledge VALUES(2,2,1);
INSERT kdi_t_priviledge VALUES(4,4,1);
INSERT kdi_t_priviledge VALUES(8,8,1);
INSERT kdi_t_priviledge VALUES(16,16,1);
INSERT kdi_t_priviledge VALUES(32,1,2);
INSERT kdi_t_priviledge VALUES(64,2,2);
INSERT kdi_t_priviledge VALUES(128,4,2);
INSERT kdi_t_priviledge VALUES(256,8,2);
INSERT kdi_t_priviledge VALUES(512,16,2);
INSERT kdi_t_priviledge VALUES(1024,1,4);
INSERT kdi_t_priviledge VALUES(2048,2,4);
INSERT kdi_t_priviledge VALUES(4096,4,4);
INSERT kdi_t_priviledge VALUES(8192,8,4);
INSERT kdi_t_priviledge VALUES(16384,16,4);
INSERT kdi_t_priviledge VALUES(32768,1,8);
INSERT kdi_t_priviledge VALUES(65536,1,16);
INSERT kdi_t_priviledge VALUES(131072,2,16);
INSERT kdi_t_priviledge VALUES(262144,4,16);
INSERT kdi_t_priviledge VALUES(524288,8,16);
...
INSERT kdi_t_resource_type VALUES(1,'文件');
INSERT kdi_t_resource_type VALUES(2,'目录');
INSERT kdi_t_resource_type VALUES(4,'用户');
INSERT kdi_t_resource_type VALUES(8,'角色');
INSERT kdi_t_resource_type VALUES(16,'集群');
...
INSERT kdi_t_role VALUES (0,'Administrator','系统管理员角色,拥有所有的权限',-1,1);
INSERT kdi_t_role VALUES (1,'Developer','系统开发者角色,对目录、文件具有新建、执行、修改、删除权限',29491,1);
INSERT kdi_t_role VALUES (2,'Operator','系统执行者角色,对目录、文件具有浏览、执行权限',28672,1);
INSERT kdi_t_role VALUES (3,'Guest','系统访客角色,对目录、文件具有浏览权限',24576,1);
...
INSERT kdi_t_user VALUES (0,'admin','admin','管理员','','','系统管理员用户,拥有所有资源授权和所有操作权限',1);
INSERT kdi_t_user VALUES (1,'developer','developer','开发者','','','系统开发者用户,拥有Guest目录的资源授权和目录文件的增、删、改、执行、浏览权限',1);
INSERT kdi_t_user VALUES (2,'operator','operator','执行者','','','系统执行者用户,拥有Guest目录的资源授权和目录文件的浏览、执行权限',1);
INSERT kdi_t_user VALUES (3,'guest','guest','访客','','','系统访客用户,拥有Guest目录的资源授权和目录文件的浏览权限',1);
...
INSERT kdi_t_user_role VALUES (0,0);
INSERT kdi_t_user_role VALUES (1,1);
INSERT kdi_t_user_role VALUES (2,2);
INSERT kdi_t_user_role VALUES (3,3);
