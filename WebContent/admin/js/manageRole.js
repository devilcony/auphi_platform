...
Ext.onReady(function() {
			...
			var deptTree = new Ext.tree.TreePanel({
				loader : new Ext.tree.TreeLoader({
					baseAttrs : {},
					dataUrl : '../role/deptTreeInit.shtml'
				}),
				root : root,
				title : '',
				applyTo : 'deptTreeDiv',
									...
									if (login_account == parent.DEFAULT_DEVELOP_ACCOUNT
										...
										if (roletype == '1') {
											Ext.MessageBox.alert('提示',
															'超级管理员和开发人员不能对业务角色授权<br>' + '业务角色只能被其所属部门或上级部门的管理员授予经办权限');
											return;
										}
									}
			...
			function roleGrantInit(roleid, deptid, roletype) {
				var operatorTab = new Ext.Panel(
						{
							title : '<img src="../resource/image/ext/config.png" align="top" class="IEPNG"> 管理权限授权',
							// iconCls: 'user_femaleIcon',
							autoLoad : {
								url : '../role/operator.shtml',
								scripts : true,
				...
				var managerTab = new Ext.Panel(
						{
							title : '<img src="../resource/image/ext/wrench.png" align="top" class="IEPNG"> 业务权限授权',
							// iconCls: 'status_onlineIcon',
							autoLoad : {
								url : '../role/manager.shtml',
								scripts : true,
								text : parent.PAGE_LOAD_MSG,
								params : {
									roleid : roleid,
