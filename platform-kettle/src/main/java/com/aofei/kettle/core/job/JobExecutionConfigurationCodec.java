package com.aofei.kettle.core.job;
...
public class JobExecutionConfigurationCodec {
    ...
    public static JobExecutionConfiguration decode(JSONObject jsonObject, AbstractMeta meta) throws ParserConfigurationException, SAXException, IOException {
        ...
        String remote_server = jsonObject.getString("remote_server");
        ...
        for (int i = 0; i < jsonArray.size(); i++) {
            ...
            if (com.aofei.utils.StringUtils.isEmpty(paramValue)) {
        ...
        executionConfiguration.setStartCopyName(jsonObject.getString("start_copy_name"));
        executionConfiguration.setStartCopyNr(jsonObject.getIntValue("start_copy_nr"));

        executionConfiguration.setGatheringMetrics("Y".equalsIgnoreCase(jsonObject.getString("gather_metrics")));
        executionConfiguration.setExpandingRemoteJob("Y".equalsIgnoreCase(jsonObject.getString("expand_remote_job")));
