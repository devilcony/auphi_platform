...
Ext.onReady(function(){
            mainTabs = new Ext.TabPanel({
                ...
                items:[{
                      ...
                      html:"<iframe name='mainFrame'  src='../index/welcome.shtml' scrolling='auto' frameborder='0' width='100%' height='100%' ></iframe>"
                    }]
             });
...
<table border="0" cellpadding="0" cellspacing="0" width="100%"  
	height="60" background="${contextPath}/resource/image/banner_background/${theme}.png">
	<tr >
