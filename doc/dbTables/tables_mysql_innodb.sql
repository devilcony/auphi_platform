/*
 ...
 Source Server         : 192.168.88.103
 Source Server Type    : MariaDB
 Source Server Version : 100307
 Source Host           : 192.168.88.103:3306
...
CREATE TABLE `COMPARE_SQL`  (
  ...
  `REPOSITORY_NAME` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '资源库ID',
  `ID_DATABASE` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'ID in r_databsae table',
  `ID_REFERENCE_DB` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '参考sql数据库ID',
  `ID_COMPARE_TABLE_GROUP` bigint(64) NULL DEFAULT NULL COMMENT 'ID in profile_table_group',
  `COMPARE_NAME` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'profile_name',
  `COMPARE_DESC` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'compare desc',
  ...
  `REFERENCE_SQL` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  ...
  `UPDATE_USER` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '修改用户',
...
CREATE TABLE `COMPARE_SQL_COLUMN`  (
  ...
  `COLUMN_TYPE` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `REFERENCE_COLUMN_NAME` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `COLUMN_DESC` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  `CREATE_USER` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建用户',
  `UPDATE_USER` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '修改用户',
...
CREATE TABLE `COMPARE_SQL_RESULT`  (
  ...
  `COLUMN_VALUE` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `REFERENCE_COLUMN_VALUE` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `DATASERVICE_AUTH`  (
  ...
  `AUTH_IP` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `USE_DESC` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `USE_DEPT` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `USER_NAME` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `CREATE_USER` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建用户',
  `UPDATE_USER` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '修改用户',
  `CREATE_TIME` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `UPDATE_TIME` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
  `DEL_FLAG` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '是否删除  1：已删除  0：正常',
...
CREATE TABLE `DATASERVICE_INTERFACE`  (
  ...
  `SERVICE_IDENTIFY` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'Client调用时唯一识别的标示',
  `SERVICE_URL` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `JOB_TYPE` int(11) NULL DEFAULT NULL COMMENT '1表示job，2表示trans，3表示自定义',
  `TRANS_NAME` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `RETURN_TYPE` int(11) NULL DEFAULT NULL COMMENT '用户可以自己选的，只支持FTP和Webservice\r\n            1表示FTP，2表示Webservice\r\n            ',
  `DATASOURCE` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  `TABLENAME` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `DELIMITER` varchar(5) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `FIELDS` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `CONDITIONS` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `CREATEDATE` datetime(0) NULL DEFAULT NULL,
  `INTERFACE_DESC` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `DATASERVICE_JOB_LOG`  (
  ...
  `CHANNEL_ID` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '唯一，通UUID表示\r\n            ',
  `JOBName` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `JOB_CN_NAME` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  `LOG_FIELD` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `EXECUTING_SERVER` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `EXECUTING_USER` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `EXCUTOR_TYPE` tinyint(4) NULL DEFAULT NULL COMMENT '1:表示本地，2表示远程，3表示集群',
  `JOB_LOG` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `CREATE_USER` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建用户',
  `UPDATE_USER` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '修改用户',
  `CREATE_TIME` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `UPDATE_TIME` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
...
CREATE TABLE `DATASERVICE_MONITOR`  (
  ...
  `systemName` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `CREATE_USER` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建用户',
  `UPDATE_USER` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '修改用户',
  `CREATE_TIME` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `UPDATE_TIME` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
...
CREATE TABLE `DATASERVICE_MONITOR_STEP_INFO`  (
  ...
  `MONITOR_ID` bigint(64) NULL DEFAULT NULL,
  `STEPNAME` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `READRECORDCOUNT` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `RETURNRECORDCOUNT` bit(20) NULL DEFAULT NULL,
  `STARTDATE` datetime(0) NULL DEFAULT NULL,
  `ENDDATE` datetime(0) NULL DEFAULT NULL,
  `COSTTIME` int(11) NULL DEFAULT NULL,
  `STATUS` int(11) NULL DEFAULT NULL,
  `LOGINFO` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `CREATE_USER` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建用户',
  `UPDATE_USER` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '修改用户',
  `CREATE_TIME` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `UPDATE_TIME` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
...
CREATE TABLE `DATASERVICE_USER`  (
  ...
  `SYSTEM_IP` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `SYSTEM_DESC` varchar(400) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `CREATE_USER` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建用户',
  `UPDATE_USER` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '修改用户',
  `CREATE_TIME` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `UPDATE_TIME` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
...
CREATE TABLE `DATASOURCE_FTP`  (
  ...
  `HOST_NAME` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'FTP管理' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'HADOOP管理' ROW_FORMAT = Dynamic;
...
CREATE TABLE `LOG_JOB_STEP`  (
  `JOB_STEP_ID` bigint(64) NOT NULL,
  ...
  `JOBNAME` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '父JOB的名称',
  `STEPNAME` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `LINES_READ` bigint(20) NULL DEFAULT NULL,
  `LINES_WRITTEN` bigint(20) NULL DEFAULT NULL,
  `LINES_UPDATED` bigint(20) NULL DEFAULT NULL,
  `LINES_INPUT` bigint(20) NULL DEFAULT NULL,
  ...
  `SETP_LOG` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`JOB_STEP_ID`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `LOG_TRANS`  (
  ...
  `TRANSNAME` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `STATUS` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `LINES_READ` bigint(20) NULL DEFAULT NULL,
  `LINES_WRITTEN` bigint(20) NULL DEFAULT NULL,
  `LINES_UPDATED` bigint(20) NULL DEFAULT NULL,
  ...
  `EXECUTING_USER` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `EXCUTOR_TYPE` tinyint(4) NULL DEFAULT NULL COMMENT '1:表示本地，2表示远程，3表示集群',
  `LOGINFO` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `TRANS_CN_NAME` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `LOG_TRANS_STEP`  (
  `TRANS_ID` bigint(64) NULL DEFAULT NULL,
  `STEP_ID` bigint(20) NOT NULL AUTO_INCREMENT,
  `CHANNEL_ID` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `LOG_DATE` datetime(0) NULL DEFAULT NULL,
  `TRANSNAME` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `STEPNAME` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  `ERRORS` bigint(20) NULL DEFAULT NULL,
  `SETP_LOG` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `COSTTIME` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `MDM_DATA_CLEAN`  (
  ...
  `ATTRIBUTE_MODEL` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `REPOSITORY_NAME` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `MDM_ID_DATABASE` bigint(20) NULL DEFAULT NULL,
  `MDM_SCHEMA_NAME` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `MDM_TABLE_NAME` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `MDM_PRIMARY_KEY` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `MDM_COLUMN_NAME` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `MDM_WHERE_CONDITION` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `MAPING_MODE` int(11) NULL DEFAULT NULL,
  `MAPING_ID_DATABASE` bigint(20) NULL DEFAULT NULL,
  `MAPING_SCHEMA_NAME` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `MAPING_TABLE_NAME` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `CREATE_USER` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建用户',
  `UPDATE_USER` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '最后修改用户',
  `CREATE_TIME` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `UPDATE_TIME` datetime(0) NULL DEFAULT NULL COMMENT '最后时间更新',
  `DEL_FLAG` tinyint(4) NULL DEFAULT 0 COMMENT '是否删除  1：已删除  0：正常',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '数据映射' ROW_FORMAT = Dynamic;
...
CREATE TABLE `MDM_MODEL`  (
  ...
  `MODEL_DESC` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `MODEL_STATUS` varchar(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `MODEL_AUTHOR` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `MODEL_NOTE` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `MODEL_CODE` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `CREATE_USER` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建用户',
  `UPDATE_USER` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '最后修改用户',
  `CREATE_TIME` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `UPDATE_TIME` datetime(0) NULL DEFAULT NULL COMMENT '最后时间更新',
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '主数据模型' ROW_FORMAT = Dynamic;
...
CREATE TABLE `MDM_MODEL_ATTRIBUTE`  (
  ...
  `ATTRIBUTE_NAME` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '主数据模型属性' ROW_FORMAT = Dynamic;
...
CREATE TABLE `MDM_MODEL_CONSTAINT`  (
  ...
  `CONSTAINT_NAME` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '约束名称',
...
CREATE TABLE `MDM_TABLE`  (
  ...
  `REPOSITORY_NAME` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '资源库名称',
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '主数据表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `PROFILE_TABLE`  (
  ...
  `REPOSITORY_NAME` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '资源库名称',
  `ID_DATABASE` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'ID in r_databsae table',
  `ID_PROFIEL_TABLE_GROUP` bigint(64) NULL DEFAULT NULL COMMENT 'ID in profile_table_group',
  `PROFIEL_NAME` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'profile_name',
  `PROFIEL_DESC` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'profile_name',
  `SCHEMA_NAME` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `TABLE_NAME` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
...
CREATE TABLE `PROFILE_TABLE_COLUMN`  (
  ...
  `PROFILE_TABLE_COLUMN_NAME` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `PROFILE_TABLE_COLUMN_TYPE` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '字段类型',
  `PROFILE_TABLE_COLUMN_SIZE` int(11) NULL DEFAULT NULL,
  `PROFILE_TABLE_COLUMN_PRECISION` int(11) NULL DEFAULT NULL COMMENT '精度',
  `PROFILE_TABLE_COLUMN_DESC` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `PROFILE_TABLE_GROUP`  (
  ...
  `PROFIEL_TABLE_GROUP_NAME` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `PROFIEL_TABLE_GROUP_DESC` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0',
  `CREATE_USER` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建用户',
  `UPDATE_USER` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '修改用户',
  `UPDATE_TIME` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
  `DEL_FLAG` int(11) NULL DEFAULT NULL COMMENT '是否删除  1：已删除  0：正常',
...
CREATE TABLE `PROFILE_TABLE_RESULT`  (
  ...
  `INDICATOR_DATA_TYPE` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  ...
  `INDICATOR_AGG_AVG` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `INDICATOR_AGG_MAX` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `INDICATOR_AGG_MIN` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `CREATE_TIME` datetime(0) NULL DEFAULT NULL,
  `EXECUTE_SQL` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `CREATE_USER` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建用户',
  `UPDATE_USER` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '修改用户',
  `UPDATE_TIME` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
  `DEL_FLAG` int(11) NULL DEFAULT NULL COMMENT '是否删除  1：已删除  0：正常',
...
-- ----------------------------
INSERT INTO `QRTZ_FIRED_TRIGGERS` VALUES ('quartzScheduler', 'NON_CLUSTERED1542346549593', 'string.ktr', 'string', 'NON_CLUSTERED', 1542349419019, 1542349429000, 5, 'ACQUIRED', NULL, NULL, '0', '0');
...
CREATE TABLE `QRTZ_GROUP`  (
  ...
  `DESCRIPTION` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '分组描述',
  PRIMARY KEY (`ID_GROUP`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '调度分组' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `QRTZ_JOB_DETAILS` VALUES ('quartzScheduler', 'string.ktr', 'string', NULL, 'com.aofei.schedule.job.TransRunner', '0', '0', '0', '0', );
INSERT INTO `QRTZ_JOB_DETAILS` VALUES ('quartzScheduler', 'string2.ktr', 'string', NULL, 'com.aofei.schedule.job.TransRunner', '0', '0', '0', '0', );
...
-- ----------------------------
INSERT INTO `QRTZ_SIMPLE_TRIGGERS` VALUES ('quartzScheduler', 'string.ktr', 'string', -1, 10000, 83766);
INSERT INTO `QRTZ_SIMPLE_TRIGGERS` VALUES ('quartzScheduler', 'string2.ktr', 'string', -1, 10000, 83766);
...
-- ----------------------------
INSERT INTO `QRTZ_TRIGGERS` VALUES ('quartzScheduler', 'string.ktr', 'string', 'string.ktr', 'string', NULL, 1542349439000, 1542349429000, 5, 'ACQUIRED', 'SIMPLE', 1541511779000, 0, NULL, 0, '');
INSERT INTO `QRTZ_TRIGGERS` VALUES ('quartzScheduler', 'string2.ktr', 'string', 'string2.ktr', 'string', NULL, 1542349439000, 1542349429000, 5, 'WAITING', 'SIMPLE', 1541511779000, 0, NULL, 0, '');
...
-- ----------------------------
INSERT INTO `R_DATABASE` VALUES (1, 'a', 19, 1, 'a', 'a', 1433, 'a', 'Encrypted 2be98afc86aa7f2e4cb79ce10bef2cfdb', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `SYS_ORGANIZER`  (
  ...
  `ORGANIZER_NAME` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '组织名称',
  `ORGANIZER_CONTACT` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `ORGANIZER_EMAIL` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `ORGANIZER_TELPHONE` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `ORGANIZER_MOBILE` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `ORGANIZER_ADDRESS` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `ORGANIZER_VERIFY_CODE` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '组织信息' ROW_FORMAT = Dynamic;
...
-- Records of SYS_USER
-- ----------------------------
INSERT INTO `SYS_USER` VALUES (1, 'admin', 'e10adc3949ba59abbe56e057f20f883e', 'admin', '381906259@qq.com', '13614019065', NULL, NULL, NULL, 0, '2018-11-15 23:00:54', '0:0:0:0:0:0:0:1', NULL, NULL, NULL, NULL, 0);
